...
TEST_CASE("HTML validation tests")
{
    SECTION("Valid string")
    {
        ...
        CHECK(HTMLParser::is_valid_html_string(html_case));

        std::wstring doctype_spaces = L"<!DOCTYPE      html    ><html></html>";
        CHECK(HTMLParser::is_valid_html_string(doctype_spaces));
    }
    ...
    SECTION("Invalid string")
    {
        ...
        CHECK_FALSE(HTMLParser::is_valid_html_string(root_double));
