...
At the current moment, I have not written any code. I've been reading through the WebKit code and documentation to get a feel for how rendering engines function. However, please note that I will not be taking any code from the WebKit project. This will be strictly my own work (unless, of course, you decide to contribute some code!).
